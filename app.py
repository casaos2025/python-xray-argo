...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'deplexo.casaos.bond')        # Argo固定隧道域名,留空使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiZjZiMDcxMTUxMzQ5MzAwMWQzNDY2OWM0ODc1NWNjZWIiLCJ0IjoiMDRkMTMzZDktYjY4NS00OWJjLTlhZDAtM2U0NDVhNDY1MTBiIiwicyI6Ill6VTJaamszTlRFdE1qUTVZaTAwTkdaa0xXSXdOekV0TXpCaU9EWm1OMkptTW1FeSJ9')            # Argo固定隧道token或json,留空使用临时隧道
...
NAME = os.environ.get('NAME', 'deplexo')                      # 节点名称
