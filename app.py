...
UUID = os.environ.get('UUID', '1e5c3cc4-6ace-4226-b800-4b1ff8d285')  # UUID
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'infrlo.casaos.bo')        # Argo固定隧道域名,留空使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiZjZiMDcxMTUxMzQ5MzAwMWQzNDY2OWM0ODc1NWNjZWIiLCJ0IjoiNDBkMmVkMzMtYmIyMC00OTYzLTg0YjEtMjliODI2ODg1MGFjIiwicyI6Ik16aGpPVFk0TTJFdE1XRXpOQzAwWm1Ga0xXRmlOR0l0TkdSbU1UZ3dPVEl6TVRreSJ9')            # Argo固定隧道token或json,留空使用临时隧道
ARGO_PORT = int(os.environ.get('ARGO_PORT', '3000'))   # Argo隧道端口
